...
static const int64_t MAX_MONEY = 630000000 * COIN;
...
public:
    ...
    {
        // OGC: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // OGC: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // OGC: two types of block: proof-of-work or proof-of-stake
    ...
    // OGC: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // OGC: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // OGC: block index flags
    enum  
    {
