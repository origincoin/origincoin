...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click OGC: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start OGC: click-to-pay handler");
    else
...
{
    // clicking on OGC: URLs creates FileOpen events on the Mac:
